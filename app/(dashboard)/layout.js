...
export default function DashboardLayout({ children }) {
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-hubspotGray to-white">
      {/* Sidebar */}
      <aside className="w-72 bg-white border-r border-gray-200 hidden md:block shadow-lg">
        ...
        <nav className="p-6 space-y-2">
          <Link className="group flex items-center px-4 py-3 rounded-xl hover:bg-hubspotTeal/10 transition-all duration-200" href="/">
          ...
          <Link className="group flex items-center px-4 py-3 rounded-xl hover:bg-hubspotTeal/10 transition-all duration-200" href="/competitors">
            <svg className="w-5 h-5 mr-3 text-hubspotTeal group-hover:text-hubspotTeal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
